...
<html><head><title>Hello Scripts</title></head><body><h2>Custom Date Task</h2><p >Setting the date to 2025/01/01</p><p>Wed Jan 01 16:16:59 EET 2025</p><hr></hr><h2>Random Number Task</h2><p >Generating a random number between 0 and 100</p><p>40</p><hr></hr><h2>Min Max Task</h2><p >Input: 10, 20, 30</p><p>Minimum value is 10</p><p>Maximum value is 30</p><hr></hr><h2>Set a style on purple color using java color</h2><p >Color object with arguments: 128, 0, 128</p><p style="color: rgb(128, 0, 128);">This
                text is purple (if only github supported colors...)</p><hr></hr><h2>is Even Task</h2><p >Input: 10</p><p>true</p><hr></hr><h2>capitalize Task</h2><p >Inputs: 'hello there!' and an empty string</p><p>Hello there!</p><p>str is null or empty</p><hr></hr><h2>Function that takes a date and calculates age in years</h2><div><p >Input: 2000-01-01</p><p>Calculated Age: 26 years old</p></div><hr></hr><h2>Function that throws an error if password is less than 8 characters</h2><div><p >Input: 1234567</p><p >Password Length: 7</p><p style="color: red;">Error: Password must be at least 8 characters long</p></div><hr></hr><img src="https://media.tenor.com/pagVxAkHfWAAAAAM/my-job-here-is-done-bye.gif"></img></body></html>
